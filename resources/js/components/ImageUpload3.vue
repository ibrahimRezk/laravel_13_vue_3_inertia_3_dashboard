...
const maxFilesNumber = ref();
// const maxFilesNumber = computed(()=> {
//  return  props.maxFiles - props.item.images.length
// });
...
onMounted(() => {
    ...
    dzInstance =  new Dropzone('#image-upload', {
        ...
        removedfile: async function  (file: any) {
            ...
            if (file.image_id) {
                ...
                const deleteResponse = await http.delete(image.destroy.url({ id: file.image_id }));
                console.log(deleteResponse)
                
                
                if (maxFilesNumber.value < props.maxFiles && deleteResponse ) {
                    console.log('deleteResponse')
            ...
            dzInstance.options.maxFiles =  maxFilesNumber.value
    ...
    dzInstance.on('success', (file: any, response: any) => {
        ...
        console.log('jjjjjj')
        file.image_id = response.image.id;
        maxFilesNumber.value--;

        dzInstance.options.maxFiles-- ;
    });
});
